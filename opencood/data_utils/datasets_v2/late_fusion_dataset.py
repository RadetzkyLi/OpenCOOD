...
class LateFusionDataset(basedataset.BaseDataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.partname == 'train':
            reformat_data_dict = self.get_item_train(base_data_dict, idx)
        else:
            reformat_data_dict = self.get_item_test(base_data_dict, idx)

        return reformat_data_dict

    def get_item_single_car(self, selected_cav_base, idx):
        """
    ...
    def get_item_train(self, base_data_dict, idx):
        ...
        selected_cav_processed = self.get_item_single_car(selected_cav_base, idx)
    ...
    def get_item_test(self, base_data_dict, idx):
        ...
        for cav_id, selected_cav_base in base_data_dict.items():
            ...
            selected_cav_processed = \
                self.get_item_single_car(selected_cav_base, idx)
...
if __name__ == '__main__':
    ...
    ds = LateFusionDataset(cfg, visualize=False)
