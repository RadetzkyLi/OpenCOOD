...
# Modified by: Rongsong Li <rongsong.li@qq.com>, @date: 2023-12-18
...
from opencood.data_utils.datasets_v2 import basedataset
...
class IntermediateFusionDatasetV2(basedataset.BaseDataset):
    ...
    def __init__(self, params, visualize, partname='train'):
        ...
        self.pre_processor = \
            build_preprocessor(params['preprocess'], train_flag)
        self.post_processor = \
            post_processor.build_postprocessor(params['postprocess'], train_flag)
    ...
    def __getitem__(self, idx):
        ...
        object_stack_list = []  # object stack for each CAV/RSU
        ...
        label_dict_no_coop = []
        for boxes, points in zip(object_stack_list, projected_lidar_stack):
    ...
    def get_item_single_car(self, selected_cav_base, ego_pose, idx):
        ...
        scenario_name,_,cav_id,_ = self.decode_data_index(idx)
        lidar_np = self.mask_ego_points(lidar_np, scenario_name, cav_id)
...
if __name__ == '__main__':
    ...
    cfg = load_yaml(hypes_yaml)
    ds = IntermediateFusionDatasetV2(cfg, visualize=False)

    # 
    data = ds.__getitem__(2000)